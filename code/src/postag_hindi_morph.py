...
nouns={}
f1.close()
os.system("fst-compiler ../src/hindi_multiple.fst ../src/hindi_multiple.a ")
f1=open("../src/hindi_pos_wx.txt","r")
f2=open("../src/hindi_morphed.txt","w")
for line in f1:
	line=line.replace('\n','')
	if line!='':
		line=line.split(' ')
			...
			if len(w)==2:
				if w[1]=="NN" or w[1]=="NNS":
					try:
						...
						f5.write(w[0])
						f5.close()
						os.system("fst-parse ../src/hindi_multiple.a ../src/multiplelex > ../src/out")
						f5=open("../src/out","r")
						for j in f5:
...
f2=open("../src/hindi_test_morphed.txt","w")
#----------------------------------------- MORPH FOR TEST DATA ------------------------------------------------------
for line in f1:
	line=line.replace('\n','')
	if line!='':
...
#--------------------------------------------------------------------------------------------------------------------
f2=open("../src/hindi_morphed.txt","r")
f3=open("../src/hindi_test_morphed.txt","r")
f4=open("../src/hindi_morphed.out","w")
...
os.system("rm ../src/hindi_test_morphed.txt ../src/hindi_morphed.txt ../src/multiplelex ../src/out")
